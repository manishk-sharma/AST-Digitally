...
/**
 * Central glowing AI core — animated icosahedron with vertex displacement.
 * Serves as the visual centerpiece of the hero scene.
 */
export default function AICore() {
  ...
  const vertexShader = `
    ...
    void main() {
      ...
      float pulse = sin(uTime * 0.8) * 0.03;
  ...
  const fragmentShader = `
    ...
    void main() {
      ...
      float colorMix = sin(vDisplacement * 10.0 + uTime * 0.5) * 0.5 + 0.5;
      vec3 color = mix(uColor1, uColor2, colorMix);

      // Add fresnel glow
      color += fresnel * uColor2 * 1.5;
