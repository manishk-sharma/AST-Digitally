...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex w-full">
      ...
      >
        {children}
        <ChevronDownIcon className="pointer-events-none shrink-0 ml-auto size-4 text-neutral-500 transition-transform duration-300 group-data-[state=open]/accordion-trigger:rotate-180" />
      </AccordionPrimitive.Trigger>
