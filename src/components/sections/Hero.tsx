        ...
        <div className="grid gap-12 lg:grid-cols-12 items-center">
          ...
          <div className="lg:col-span-7 max-w-3xl">
            ...
            <motion.div
              ...
              className="flex flex-wrap items-center gap-2 text-[10px] sm:text-xs font-mono tracking-wider text-muted-foreground uppercase mb-6"
            >
              <span className="h-px w-8 bg-muted-foreground/30 shrink-0" />
            ...
            <motion.h1
              ...
              className="mb-8 text-3xl font-extrabold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl text-foreground leading-[1.15] max-w-2xl"
            >
            ...
            <motion.p
              ...
              className="mb-8 max-w-xl text-sm sm:text-base leading-relaxed text-neutral-700 md:text-lg font-normal"
            >
            ...
            >
              <a
                ...
                className={cn(
                  ...
                  "rounded-lg bg-primary text-primary-foreground px-6 py-4 text-sm font-semibold transition-all duration-300 hover:bg-primary/90 hover:scale-[1.01] shadow-[0_2px_10px_rgba(0,0,0,0.08)] flex items-center justify-center gap-2"
                )}
              >
              ...
              <a
                ...
                className={cn(
                  ...
                  "rounded-lg border-border bg-white text-foreground px-6 py-4 text-sm font-semibold transition-all duration-300 hover:bg-secondary/20 hover:scale-[1.01] shadow-[0_2px_10px_rgba(0,0,0,0.035)] text-center"
                )}
              >
                Explore Services
              </a>
